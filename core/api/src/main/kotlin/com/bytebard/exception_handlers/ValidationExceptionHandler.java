package com.bytebard.exception_handlers;

import com.bytebard.dtos.ApiErrorResponse;
...
public class ValidationExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleNotFoundExceptions(Exception ex) {
